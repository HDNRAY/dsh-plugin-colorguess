...
function palette(theme) {
  return theme === "dark" ? { bg: "#0f1115", text: "#eceef2", secondary: "#a3aab6", border: "rgba(236,238,242,0.12)" } : { bg: "#f4f5f7", text: "#16181d", secondary: "#5f6672", border: "rgba(22,24,29,0.10)" };
}
